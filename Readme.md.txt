This is a Battery overcharging notifier which triggers a warning notification when the device reaches 99% battery threshold. It prevents overcharging and keep your battery healthy in a long run. .
